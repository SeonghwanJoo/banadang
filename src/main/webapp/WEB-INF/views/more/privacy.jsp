...
<div class="agreement-content">
	...
	<br>&nbsp;&nbsp; - 전화번호, 서비스 서비스 이용기록, 접속 로그 및 인증일자, 결제기록, 서비스버전, 통신사정보, 단말기 정보(모델명, OS버전, 기기고유식별번호, Mac Address 등), 카카오 회원번호, 카카오톡 닉네임, 카카오톡 프로필사진, 카카오톡 친구목록 및 친구의 프로필사진<br>
	...
	<br>&nbsp; - 본인확인: 성명, 신분을 확인할 수 있는 증서<br>
	3. 만14세 미만 아동의 회원가입 등 개인정보 수집 필요 시 법정대리인의 동의여부를 확인하기 위하여, 법정대리인의 성명, 연락처 등의 정보를 수집할 수 있습니다. 법정대리인이 동의하지 않는 경우 해당 정보는 파기됩니다.<br>
	4. 회사는 고객이 회사의 홈페이지, 기타 회사가 제공하는 서비스 이용 시 이용기록, 접속로그, 접속IP정보, 결제기록 등 생성정보를 수집합니다.<br>
	5. 회사는 홈페이지 회원가입, 서면양식, 회원정보 수정, 전화, 팩스, 고객응대 창구, 이벤트 응모, 서비스 내 수집 등의 방법으로 개인정보를 수집합니다.<br>
	</p>
