...
<div class="row">
	<div class="col align-center">
		...
		<div class="centered-padding">
			<button onclick="inviteMember()" class="block blue-bg">가입 하기</button>
		</div>
	</div>
</div>
</c:if>
...
<div id="login_modal" class="certify-modals">
	<!-- Modal content -->
	<div class="certify-modal-content">
		<div class="sub-content centered-padding">
			<div class="main-row">
				<div class="login">
...
function login(throughTalk){
   ...
   if($('input:checkbox').is(':checked')){
	...
	location.href=uri; */
	var state = ${club.club_num};
	if($('input:checkbox').is(':checked')){
		state+="&-true";
	}
	Kakao.Auth.authorize({
		  redirectUri: $(location).attr('protocol')+"//${pageContext.request.serverName }${pageContext.request.contextPath}/member/invitedLogin.do"
