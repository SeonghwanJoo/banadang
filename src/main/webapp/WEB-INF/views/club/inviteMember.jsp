...
function loginProcess(){
	...
	location.href="https://kauth.kakao.com/oauth/authorize?client_id=0646bcb11e5b9bbdb24fc9153f7693ae&redirect_uri=http://localhost:8080/banadang/member/invitedLogin.do&response_type=code&state=${club.club_num }-"+nickname;
};
$(function(){
