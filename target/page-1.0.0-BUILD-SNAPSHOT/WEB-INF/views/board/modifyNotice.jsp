...
<form:form class="col s12" id="updateNoticeForm" action="updateNotice.do" commandName="boardVO" autocomplete="off">
<input type="hidden" name="notice_num" value="${board.notice_num }">
<div class="row" id="top_wrap">
	<div class="fixed_top">
		<a onclick="location.href='notice.do'">
...
<div class="row">
	<div class="text input-container col">
		<textarea class="detail input-field" name="content" id="content" placeholder="공지 사항 내용을 입력해주세요.">${board.content }</textarea>
	</div>
</div>
